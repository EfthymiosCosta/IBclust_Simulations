...
The `res` directory includes the results files for the 3 simulation studies (synthetic non-spherical, synthetic spherical, real-world data), the simulation results for the knee heuristic and the Gap statistic, and the runtime analysis results. The results for the pairwise repeated-measures ANOVAs are in the `anova_res` directory.
