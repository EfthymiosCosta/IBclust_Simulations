...
fullfactorial_res_sph <- data.frame(seed=numeric(),
                                    nClust=numeric(),
                                    overlap=numeric(),
                                    nrows=numeric(),
                                    ncols=numeric(),
          ...
          for (pi_val in pi_values){
            ...
            for (cat_ratio in cat_ratios){
              ...
              pam_fit <- pam(gower_dist, diss = TRUE, k = clusters, do.swap = FALSE, cluster.only = TRUE,
                             nstart=100)
              fullfactorial_res_sph <- rbind(fullfactorial_res_sph, data.frame(seed=l+1, nClust=clusters, overlap=overlap,
              ...
              save(fullfactorial_res_sph, file='fullfactorial_res_sph.RData')
              ...
              fullfactorial_res_sph <- rbind(fullfactorial_res_sph, data.frame(seed=l+1, nClust=clusters, overlap=overlap, nrows=rows,
              ...
              save(fullfactorial_res_sph, file='res/fullfactorial_res_sph.RData')
